...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <div className="absolute left-0 bottom-[-6px] transform translate-y-full text-xs ">0</div>
    <div className="absolute right-0 bottom-[-6px] transform translate-y-full text-xs">1</div>
  </SliderPrimitive.Root>
));
